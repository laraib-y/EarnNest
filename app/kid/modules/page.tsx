        ...
        <section className="kid-modules-content">
          <div className="kid-modules-grid">
            <article className="kid-module-card">
              <div className="kid-module-card-inner">
                <div className="kid-module-card-content">
                  <div className="kid-module-top">
                    ...
                    <div className="kid-module-crow kid-module-crow-right">
                      <img
                        src="/assets/NeedsWants.svg"
                        alt="Wants Needs crow"
                        className="kid-crow-image"
                      />
                    </div>
                  </div>
